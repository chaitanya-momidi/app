...
public class Config {
    ...
    //Set to true if you would like to display a splash screen on boot. Drawable shown is 'vert_loading1'
    ...
    public static final Object[] TITLES = new String[]{"Jobsearchers","Student-Community","News","Portfolio"};
    //The URL's of your web items
    public static final String[] URLS = new String[]{"https://jobsearchers.org.in","https://jobsearchers.xyz","https://news.jobsearchers.xyz","https://mjkc.ml"};
    ...
    public static int DRAWER_ICON = R.drawable.vert_loading1;
